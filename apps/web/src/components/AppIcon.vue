...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'folder-open'">
      <path d="M3 7V6.5A1.5 1.5 0 0 1 4.5 5H9l2 2h7.5A1.5 1.5 0 0 1 20 8.5V10" />
      <path d="M4.5 10h16l-2 8.5a1.5 1.5 0 0 1-1.5 1H5a1.5 1.5 0 0 1-1.5-1L2 12a1.6 1.6 0 0 1 1.5-2Z" />
    </template>

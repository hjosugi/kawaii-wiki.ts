/** Pure Markdown ⇄ editable-DOM conversion used by the visual editor. */
...
export const editableDomToMarkdown = (root: Element): string => {
  const markdown = childrenMarkdown(root).trimEnd()

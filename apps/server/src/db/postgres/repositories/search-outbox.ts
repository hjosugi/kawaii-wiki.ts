...
/** PostgreSQL implementation of the driver-neutral search-outbox contract. */
export const createPostgresSearchOutboxRepository = (db: PostgresDb): SearchOutboxRepository => ({
